	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"80%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">原摊位名称</div>
					<div  class="info_text" >{{detail.tanweimingcheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">摊位位置</div>
					<div  class="info_text" >{{detail.tanweiweizhi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">月租金</div>
					<div  class="info_text" >{{detail.yuezujin}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">申请类型</div>
					<div  class="info_text" >{{detail.shenqingleixing}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">新摊位名称</div>
					<div  class="info_text" >{{detail.xintanweimingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('tanweishenqingdiaozheng','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('tanweishenqingdiaozheng','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('tanweishenqingdiaozheng','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
