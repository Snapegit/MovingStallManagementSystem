<template>
	<div class="app-contain" :style='{"width":"80%","padding":"0px 20px 10px","margin":"30px auto 40px","position":"relative","borderRadius":"0px","background":"none"}'>
