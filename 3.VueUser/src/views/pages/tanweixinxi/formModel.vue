	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"80%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">摊位状态</div>
					<div  class="info_text" >{{detail.tanweizhuangtai}}</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'申请')" @click="tanweishenqingdiaozhengonAcross('申请','tanweishenqingdiaozheng','','tanweizhuangtai','已出租','已出租,未出租'.split(',')[0])" type="warning">申请</el-button>
...
<script setup>
	...
	const tanweishenqingdiaozhengonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
