...
public class DiscusstejiashangpinController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusstejiashangpinEntity discusstejiashangpin, 
		HttpServletRequest request){
        EntityWrapper<DiscusstejiashangpinEntity> ew = new EntityWrapper<DiscusstejiashangpinEntity>();
    ...
    public R info(@PathVariable("id") Long id){
		...
		discusstejiashangpin = discusstejiashangpinService.selectView(new EntityWrapper<DiscusstejiashangpinEntity>().eq("id", id));
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscusstejiashangpinEntity discusstejiashangpin, HttpServletRequest request,String pre){
        EntityWrapper<DiscusstejiashangpinEntity> ew = new EntityWrapper<DiscusstejiashangpinEntity>();
